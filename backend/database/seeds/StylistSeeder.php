...
class StylistSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('stylists')->insert([[
            ...
            'image_link' => "http://localhost:8000/upload/stylists/team1.jpg",
        ],
            [
                'stylist_name' => 'Thúy Vân',
                'phone_number' => '0126808080',
                'information' => $faker->paragraph($nbSentences = 1),
                'image_link' => "http://localhost:8000/upload/stylists/team2.jpg",
            ],
            [
                'stylist_name' => 'Thị Thắm',
                'phone_number' => '0127488456',
                'information' => $faker->paragraph($nbSentences = 1),
                'image_link' => "http://localhost:8000/upload/stylists/team3.jpg",
            ],
            [
                'stylist_name' => 'Ngọc Huyền',
                'phone_number' => '0976420088',
                'information' => $faker->paragraph($nbSentences = 1),
                'image_link' => "http://localhost:8000/upload/stylists/team4.jpg",
            ],
            [
                'stylist_name' => 'Thúy Kiều',
                'phone_number' => '0126420123',
                'information' => $faker->paragraph($nbSentences = 1),
                'image_link' => "http://localhost:8000/upload/stylists/team5.jpg",
            ],
            [
                'stylist_name' => 'Thúy Na',
                'phone_number' => '0127420456',
                'information' => $faker->paragraph($nbSentences = 1),
                'image_link' => "http://localhost:8000/upload/stylists/team6.jpg",
            ],
            [
                'stylist_name' => 'Thủy Tiên',
                'phone_number' => '0126420496',
                'information' => $faker->paragraph($nbSentences = 1),
                'image_link' => "http://localhost:8000/upload/stylists/team7.jpg",
            ]
        ]);
    }
